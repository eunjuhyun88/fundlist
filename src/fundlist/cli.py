...
def build_parser() -> argparse.ArgumentParser:
    ...
    submission_scan.add_argument("--review-targets", action="store_true", help="Prepend unresolved review-target seeds")
    submission_scan.add_argument("--review-targets-only", action="store_true", help="Retry unresolved review-target seeds only")
    submission_scan.add_argument("--review-target-limit", type=int, default=80, help="Max unresolved review-target seeds to load")
